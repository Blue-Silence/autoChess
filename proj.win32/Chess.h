...
// 生命值
int const hpData[HERONUM] = { 3229,3019,3182,3242,3500,3450 };
// 攻击值
int const attackData[HERONUM] = { 170,168,180,169,157,153 };
// 防御值
int const defenceData[HERONUM] = { 86,89,86,95,103,125 };
// 攻击距离，指与对手在棋盘上的曼哈顿距离
int const attackDistanceData[HERONUM] = { 3,3,2,2,1,1 };
